...
class curl {
    ...
    public function resetopt(){
        $this->options = array();
        $this->options['CURLOPT_USERAGENT']         = 'UserAgent/1.0';
    ...
    public function put($url, $params = array(), $options = array()){
        ...
        if (!isset($this->options['CURLOPT_USERPWD'])){
            $this->setopt(array('CURLOPT_USERPWD'=>'anonymous: noreply@example.org'));
        }
     ...
     * @return bool
     */
    public function patch($url, $param = '', $options = array()){
    ...
    public function delete($url, $param = array(), $options = array()){
        ...
        if (!isset($options['CURLOPT_USERPWD'])) {
            $options['CURLOPT_USERPWD'] = 'anonymous: noreply@example.org';
        }
        $ret = $this->request($url, $options);
        return $ret;
    }
